...
mod tests {
    ...
    fn test_title_cannot_be_empty() {
        Ticket::new("".to_string(), valid_description(), valid_status());
    }

    #[test]
    #[should_panic(expected = "Title cannot be longer than 50 bytes")]
    fn test_title_cannot_be_longer_than_fifty_chars() {
        Ticket::new(overly_long_title(), valid_description(), valid_status());
    }

    #[test]
    #[should_panic(expected = "Description cannot be empty")]
    fn test_description_cannot_be_empty() {
        Ticket::new(valid_title(), "".to_string(), valid_status());
    }

    #[test]
    #[should_panic(expected = "Description cannot be longer than 500 bytes")]
    fn test_description_cannot_be_longer_than_500_chars() {
        Ticket::new(valid_title(), overly_long_description(), valid_status());
    }

    #[test]
    #[should_panic(expected = "Only `To-Do`, `In Progress`, and `Done` statuses are allowed")]
    fn status_must_be_valid() {
        Ticket::new(valid_title(), valid_description(), "sunchp".to_string());
    }
